...
public class DarAltaProyecto extends JFrame {
	...
	public DarAltaProyecto() {
     ...
     // Creación del campo de dar de baja
        txtCodAlum = new JTextField(20);
        txtCodAlum.setBounds(404, 119, 155, 25);
        panel.add(txtCodAlum);

        JLabel codAlumLabel = new JLabel("Código Alumno:");
        codAlumLabel.setFont(new Font("Tahoma", Font.PLAIN, 15));
        codAlumLabel.setBounds(170, 119, 138, 25);
     ...
     // Creación del campo de dar de baja
        ...
        darAlta = new JButton("Dar de alta proyecto");
        darAlta.setFont(new Font("Tahoma", Font.PLAIN, 15));
        darAlta.setBounds(170, 318, 389, 30);
        panel.add(darAlta);
