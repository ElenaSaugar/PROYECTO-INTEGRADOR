...
/**
 * Clase que representa la ventana de consultas de un proyecto integrador.
 */
public class ConsultasProf extends JFrame {
	 ...
	 * 
	 * @param proyecto El proyecto integrador para el cual se muestran las
	 *                 consultas.
	 */
	public ConsultasProf(DatosProyectoIntegrador proyecto, ArrayList<String> a) {
		super();
	...
	public void inicializarComponentes() {
		...
		componentesLabel.setBounds(201, 543, 1084, 46);
